...
<div class="card card-middle mt-6">
            ...
            @method('PUT')
                ...
                <div class="description">
                    ...
                    <p><textarea name="Text2" class="form-control mt-4" rows="1" required>{{ $test->Text2 }}</textarea></p>
                    <p><textarea name="price" class="form-control mt-4" rows="1" required>{{ $test->price }}</textarea></p>
                </div>
